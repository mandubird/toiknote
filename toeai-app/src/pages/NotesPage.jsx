  ...
  return (
    <div className="p-4 pb-8">
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-500 mt-1">오답을 모으고, 필터로 정리하고, 복습하세요.</p>
      </div>
...
const EmptyState = ({ hasAny }) => (
  <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
    ...
    <h3 className="text-lg font-semibold text-gray-900 mb-2">{hasAny ? '선택한 조건에 맞는 오답이 없어요' : '아직 오답이 없어요'}</h3>
    <p className="text-sm text-gray-600 mb-1">{hasAny ? '다른 파트나 태그를 선택해 보세요.' : '하단의 카메라 버튼을 눌러'}</p>
...
const QuestionCard = ({ question, onClick }) => (
  ...
  >
    ...
    <div className="flex items-start justify-between mb-2">
      <span className="inline-block px-2 py-1 text-xs font-semibold text-primary-700 bg-primary-100 rounded">{question.part}</span>
